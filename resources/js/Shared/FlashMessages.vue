<template>
  <div class="absolute" style="bottom: 20px; left: 20px; z-index: 9999999;">
    <div v-if="$page.props.flash.success && show" class="flex items-center justify-between mb-8 max-w-3xl bg-green-500 rounded">
      ...
      <button type="button" class="group mr-2 ml-4 p-2" @click="show = false">
    ...
    <div v-if="$page.props.flash.warning && show" class="flex items-center justify-between mb-8 max-w-3xl bg-indigo-500 rounded">
      <div class="flex items-center">
        <svg class="flex-shrink-0 ml-4 mr-4 w-4 h-4 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/></svg>
    ...
    <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="flex items-center justify-between mb-8 max-w-3xl bg-red-500 rounded">
      <div class="flex items-center">
        ...
        <div v-else class="py-4 text-white text-sm font-medium">
          <span v-if="Object.keys($page.props.errors).length === 1">Há um erro no formulário.</span>
